...
class Company extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['id', 'name', 'city_id', 'state_id', 'phone', 'extention', 'ring_central_extention', 'local_phone', 'local_contact_name', 'email', 'website', 'description', 'street', 'postal_code', 'image'], 'safe'],
